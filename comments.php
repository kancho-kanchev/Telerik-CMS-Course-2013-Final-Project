	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * to use telerik_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define telerik_comment() and that will be used instead.
				 * See telerik_comment() in twentyeleven/functions.php for more.
				 */
				wp_list_comments( array( 'callback' => 'telerik_comment' ) );
			?>
		</ol>
